      ...
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {TECHNOLOGIES.map((tech) => (
            <Card key={tech.title} className="p-6 border-slate-800/40 bg-background/70">
        ...
        <Card className="p-6 border-slate-800/50 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
          ...
          <div className="grid md:grid-cols-3 gap-4 mt-8">
            {PIPELINE.map((item) => (
              <div key={item.step} className="p-4 rounded-xl bg-slate-900/60 border border-slate-800">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {DEPARTMENTS.map((dept) => (
                <div key={dept.id} className="p-4 rounded-xl border border-slate-800/60 bg-background/50">
                  ...
                  <div className="flex flex-wrap gap-1 text-[11px] text-blue-300">
                    {dept.services.slice(0, 3).map((svc) => (
                      <span key={svc} className="px-2 py-0.5 rounded-full bg-blue-500/10 border border-blue-500/30">
                        {svc}
                      </span>
                    ))}
                  </div>
